...
CREATE TABLE IF NOT EXISTS items (
  ...
  last_actor_at      TEXT,
  last_owner_at      TEXT,                 -- last time OWNER_LOGIN spoke on this item
...
CREATE TABLE IF NOT EXISTS triage (
  ...
  marked_at_activity TEXT,                 -- items.last_actor_at at the time of marking
  snoozed_until TEXT,
  note          TEXT
);

-- Draft-and-hold. Nothing here has left the machine until status = 'posted'.
CREATE TABLE IF NOT EXISTS drafts (
  ...
  flags        TEXT,                       -- JSON array, e.g. ["prompt_injection_suspected"]
